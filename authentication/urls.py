...
# For attatching to signal emmitted by django_rest_passwordreset
...
def password_reset_token_created(sender, instance, reset_password_token, *args, **kwargs):
    ...
    # render email text
    email_html_message = loader.render_to_string('user_reset_password.html', context)
    email_plaintext_message = loader.render_to_string('user_reset_password.txt', context)
